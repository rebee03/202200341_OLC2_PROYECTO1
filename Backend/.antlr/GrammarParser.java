...
public class GrammarParser extends Parser {
	...
	public static final int
		...
		INT_LIT=53, FLOAT_LIT=54, STRING_LIT=55, RUNE_LIT=56, XOR=57, PIPE=58, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"BOOL_LIT", "INT_LIT", "FLOAT_LIT", "STRING_LIT", "RUNE_LIT", "XOR", 
			"PIPE", "ID", "LINE_COMMENT", "BLOCK_COMMENT", "WS"
		};
	}
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 720568989377364680L) != 0)) {
				{
				{
				setState(179);
				statement();
	...
	public final SwitchStmtContext switchStmt() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 720505578480206024L) != 0)) {
				{
				setState(259);
				expression(0);
				}
